...
class Order
{
    ...
    /*
    cascade : ['persist'] = on lui donne les permission / car on souhaite lui permettre de manipuler l'Objet OrdeDetail lorsqu'il est question de persister les données
    */
    /**
